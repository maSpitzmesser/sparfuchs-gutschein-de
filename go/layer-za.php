 ...
 <table style="width:100%;position:relative;" cellpadding="2">
  ...
  <tr>
    ...
    <td><?php if ( ($existing_customers == 'YES') && ($new_customers == 'YES') ) { echo '<span class="bk">Neu- &amp; Bestandskunden</span>'; }
			else if ( ($existing_customers == 'NO') && ($new_customers == 'YES') ) { echo '<span class="nk">Nur für Neukunden</span>';}
            else if ( ($existing_customers == 'YES') && ($new_customers == 'NO') ) { echo '<span class="nk">Nur für Bestandskunden</span>';}
            else { }
				?></td>
  </tr>
