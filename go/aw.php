<?php
  ...
  if ( isset( $_GET["id"] ) ) {
    ...
    $deeplink    = $offer->DeeplinkTracking;
...
<head>
    ...
    <link rel="stylesheet" href="/wp-content/themes/sg/styles/frame.css" type="text/css" media="screen, projection"/>
    ...
    <script type="text/javascript" src="/wp-content/themes/sg/js/jquery-3.4.1.min.js"></script>

    <meta http-equiv="refresh" content="5; url=<?php echo $deeplink; ?>">
...
<div class="redirect-container">
    <img src="https://sparfuchs-gutschein.de/wp-content/themes/sg/images/logo/sparfuchs-gutschein-logo.min.png" alt="sparfuchs-gutschein-logo.min"/>
