...
if ( isset( $_GET["id"] ) ) {
	...
	$shop = $wpdb->get_row("SELECT * FROM wp_posts WHERE ID = $shopid AND post_type = 'post' LIMIT 1");
...
if (empty($r) && $oframe == '1' ){
	$_SESSION["r"] = '1';
		echo '<meta http-equiv="refresh" content="5; url=http://sparfuchs-gutschein.de/ca.php?id='.$id.'">';
}
?>
</head>
<?php
