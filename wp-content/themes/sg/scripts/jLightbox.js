	...
	jQuery.extend(F, {
		...
		defaults: {
			...
			tpl: {
				...
				iframe   : '<iframe id="fancybox-frame{rnd}" name="fancybox-frame{rnd}" class="fancybox-iframe"  webkitAllowFullScreen mozallowfullscreen allowFullScreen' + (IE ? ' allowtransparency="true"' : '') + '></iframe>',

				closeBtn : '<a title="Fenster schließen" class="fancybox-item fancybox-close" href="javascript:;"></a>',
