<?php
  ...
  function __construct() {
    parent::__construct(
        'Widget_Shop_info', // widget ID
        'Shop Info', // widget name
        array('description' => 'Shop Info')  // widget description
        ); 
  }
    ...
    public function widget($args, $instance) {
      ...
      $sql          = "SELECT * FROM awin_vouchers WHERE Advertiser LIKE '%{$shopname}%' AND type = 'voucher' LIMIT 1";
  ...
  class Widget_more_Shop_infos extends WP_Widget {
      ...
      function __construct() {
    parent::__construct(
        'Widget_more_Shop_infos', // widget ID
        'more Shop Infos', // widget name
        array('description' => 'more Shop Infos')
        );  // widget description
  }
  ...
  function __construct() {
    parent::__construct(
        'Widget_Anleitung', // widget ID
        'Anleitung', // widget name
        array('description' => 'So funktioniert es') // widget description 
        );  
  }
  ...
  function __construct() {
  parent::__construct(
        'Widget_Guide', // widget ID
        'Anleitung im Shop', // widget name
        array('description' => 'Anleitung im Shop') // widget description 
        );  
  }
  ...
  class Widget_Neuste_Gutscheine extends WP_Widget {
      function __construct() {
        parent::__construct(
            'Widget_Neuste_Gutscheine', // widget ID
            'Neuste Gutscheine', // widget name
            array('description' => 'Neuste Gutscheine in der Sidebar', 'classname' => 'g')
            );  // widget description
      }
  ...
  class Widget_Popular_Coupons extends WP_Widget {
      ...
      function __construct() {
    parent::__construct(
        'Widget_Popular_Coupons', // widget ID
        'Beliebteste Gutscheine', // widget name
        array('description' => 'Beliebteste Gutscheine in der Sidebar', 'classname' => 'g')
        );  // widget description
  }
  ...
  function __construct() {
    parent::__construct(
        'Widget_Similar_Gutscheine', // widget ID
        'Alternative Gutscheine', // widget name
        array('description' => 'Alternative Gutscheine in der Sidebar', 'classname' => 'g')
        );  // widget description
  }
...
ORDER BY o.valid_from DESC LIMIT 8";
  ...
  class Widget_Geschenkgutschein extends WP_Widget {
      ...
      function __construct() {
        parent::__construct(
            'Widget_Geschenkgutschein', // widget ID
            'Geschenkgutschein', // widget name
            array('description' => 'Geschenkgutschein')
            );  // widget description
      }
  ...
  class Widget_Facebook extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
            'Widget_Facebook', // widget ID
            'Facebook Like Box', // widget name
            array('description' => 'This places a Facebook page Like Box in your sidebar to attract and gain Likes from visitors.')
            );  // widget description
      }
...
//}(document, "script", "facebook-jssdk"));</script>';
  ...
  class Widget_Werbung_Affiliate extends WP_Widget {
      ...
      function __construct() {
    parent::__construct(
        'Widget_Werbung_Affiliate', // widget ID
        'Werbung Affiliate', // widget name
        array('description' => 'Werbung Affiliate')
        );  // widget description
  }
